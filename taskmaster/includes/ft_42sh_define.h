...
# define BUFFER_READ_42SH			0x20
# define BUFFER_OUT_42SH			0x1000
# define BUFFER_ERR_42SH			0x100
# define BUFFER_LITTER_42SH			0x20

# define FILE_PASSWD_42SH			"/etc/passwd"
# define FILE_PASSWD_MIN_42SH		0x0
# define FILE_PASSWD_MAX_42SH		0x100000
...
# define AUTO_TYPE_SET_RUN_42SH		0x8
...
# define JOBS_HRDC_42SH				0x1
# define JOBS_HRDC_EMPTY_42SH		0x2
# define JOBS_HRDC_DQ_42SH			0x4

# define DQ_HRDC_42SH				0x1
# define DQ_HRDC_ERR_42SH			0x2
...
# define PARSING_MODE_TILD_42SH		0x20
...
# define FD_MAX_STANDART_42SH		2
# define FD_MAX_SUPPORT_42SH		9
# define FD_TERMINAL_42SH			10

# define MODE_DEBUG_42SH		0x0
# define MODE_SIGCHILD_42SH		0x1
# define MODE_GUARD_42SH		0x2
# define MODE_VALG_42SH			0x4
# define MODE_LAUNCH_42SH		0x8

# define MODE_GUARD_COUNT_42SH		0xA
# define MODE_GUARD_COUNT_MAX_42SH	0x14

# define ID_LAUNCH_42SH			0x01000000

# define PIPE_CLOSE_42SH		0x1
# define PIPE_AND_42SH			0x2
# define PIPE_42SH				0x4
# define PIPE_LEFT_42SH			0x8
# define PIPE_LEFT2_42SH		0x18
# define PIPE_RIGHT_42SH		0x20
# define PIPE_RIGHT2_42SH		0x60
...
# define MSG_42SH					"$> "
# define MSG_SP_42SH				"   "
# define PRE_MSG_COUNT_42SH			3
# define PRE_MSG_LITTER_42SH		3
# define MSG_DQUOTE_42SH			"dquote> "
# define PRE_MSG_DQUOTE_LITTER_42SH	8
# define MSG_QUOTE_42SH				"quote> "
# define PRE_MSG_QUOTE_LITTER_42SH	7
# define MSG_HEREDOC_42SH			"heredoc> "
# define PRE_MSG_HEREDOC_LITTER_42SH 9
# define MSG_SUB_42SH				"sub> "
# define PRE_MSG_SUB_LITTER_42SH	5
# define MSG_CMD_42SH				"cmd> "
# define PRE_MSG_CMD_LITTER_42SH	5
...
# define MSG_JOBS_QUEST_LEN_42SH 43 - 1
...
# define HASH_HITS_LEN_42SH	19 - 8
...
# define MSG_TAB_LIM_L_42SH		24 + 16 - 1
